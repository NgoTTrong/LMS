...
export default class PaymentService {
  static getUserPaymentCourse = async (courseId: number, userId: number) => {
    try {
      const response = await RequestAPI.call(paymentRoutes.getUserPayment, {
        method: "POST",
        data: {
  ...
  static purchaseCourse = async (courseId: number, userId: number) => {
    try {
      const response = await RequestAPI.call(paymentRoutes.purchaseCourse, {
        method: "POST",
        data: {
          courseId,
          userId,
