                        ...
                        {chapters.map((chapter, index) => (
                            ...
                            >
                                {(provided) => (
                                    <div
                                        className={cn(
                                            "flex items-center bg-slate-100 border-slate-200 border text-slate-700 rounded-md mb-4 text-sm",
                                            chapter?.isPublished &&
                                    ...
                                    >
                                        <div
                                            className={cn(
                                                "px-2 py-3 border-solid border-r border-r-slate-200 hover:bg-slate-200 rounded-l-md transition mr-2",
                                                chapter.isPublished &&
