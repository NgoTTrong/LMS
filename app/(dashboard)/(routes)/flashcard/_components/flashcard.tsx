...
const FlashCard = ({ flashcard }: Props) => {
  return (
    <Link
      ...
      className="group flex flex-col justify-between rounded-xl shadow-lg border-[1px] border-gray-200  cursor-pointer hover:-translate-y-2 p-4 relative duration-200"
    >
      ...
      <div className=" revert-layer bottom-4 left-4 flex items-center">
        <img
